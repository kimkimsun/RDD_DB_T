...
//        }
//        dialogueIndex++;
//        if (dialogueIndex == questData[tempQuestIndex].questReward_index)
//        {
//            Debug.Log("보상 받는 시점 도착");
//        }
//        if (dialogueIndex == questData[tempQuestIndex].questGet_index)
//        {
...
//        }
//        if (tempDialogueData.Count - 1 == dialogueIndex)
//        {
//            dialogueContents.text = tempDialogueData[dialogueIndex].dialogues;
//            BtnText.text = "닫기";
//        }
//        else if (tempDialogueData.Count == dialogueIndex)
//        {
...
//    {
//        dialogueIndex++;
//        if (processingData.Count - 1 == dialogueIndex)
//        {
//            dialogueContents.text = processingData[dialogueIndex].processing_dialogues;
//            BtnText.text = "닫기";
//        }
//        else if (processingData.Count <= dialogueIndex)
//        {
//            questUICanvas.gameObject.SetActive(false);
//            dialogueIndex = -1;
//        }
